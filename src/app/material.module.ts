...
const MATERIAL_MODULES = [MatAutocompleteModule,
   ...
   MatDatepickerModule,MatTableModule,MatDialogModule,
   ...
   MatSnackBarModule,MatSortModule,MatStepperModule,MatToolbarModule,
   MatTooltipModule,CommonModule,MatBadgeModule,OverlayModule,PortalModule,BidiModule,A11yModule,MatCommonModule,
   ObserversModule];
   @NgModule({
      imports: [
         CommonModule,
